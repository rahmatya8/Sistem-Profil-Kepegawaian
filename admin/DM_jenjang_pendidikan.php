...
if (isset($_POST['tambah'])) {
    ...
    if ($jenjang !== "") {
        ...
        header("Location: DM_jenjang_pendidikan.php");
        exit;
    }
}
...
<aside class="sidebar" id="sidebar">
    ...
    <div class="submenu aktif" id="submenuDataMaster">
        ...
        <a href="DM_jenjang_pendidikan.php" class="item-submenu aktif">Jenjang Pendidikan</a>
        <a href="DM_hub_keluarga.php" class="item-submenu">Hubungan Keluarga</a>
